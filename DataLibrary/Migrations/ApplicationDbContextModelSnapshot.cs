...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.AdditionalLocations", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<bool>("PerimeterType")
                        .HasColumnType("bit");

                    b.Property<long?>("PerimeterTypeDigit")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Models.AssignResponseTeams", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Models.DynamicColumnOption", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("DynamicColumnId")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("DynamicColumnOptions");
                });

            modelBuilder.Entity("Models.DynamicColumnValue", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Models.EquipmentFields", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Models.IncidentHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Models.IncidentTeam", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Models.Progress", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Models.Relationship", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Models.SeverityLevel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Models.StreetServiceRequest", b =>
                {
                    ...
                    b.Property<bool>("StreetSweeping")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Models.TaskEquipment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("TaskEquipments");
                });

            modelBuilder.Entity("Models.TaskLabor", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Models.TaskMaterial", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Models.TaskTypeStep", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("TaskTypeSteps");
                });

            modelBuilder.Entity("Models.TaskWorkStep", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Models.Timesheet", b =>
                {
                    ...
                    b.Property<double>("DailyPerDiem")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Models.TimesheetBreakdown", b =>
                {
                    ...
                    b.Property<double>("DoubleTimeHours")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Models.UserSearchSetting", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Models.WorkOrder", b =>
                {
                    ...
                    b.HasIndex("StreetServiceRequestId")
                        .IsUnique()
                        .HasFilter("[StreetServiceRequestId] IS NOT NULL");
            ...
            modelBuilder.Entity("Models.WorkOrderEquipment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Models.DynamicColumnOption", b =>
                {
                    b.HasOne("Models.DynamicColumn", "DynamicColumn")
                        .WithMany("Options")
            ...
            modelBuilder.Entity("Models.IncidentUser", b =>
                {
                    b.HasOne("Models.IncidentTeam", "Team")
                        .WithMany()
            ...
            modelBuilder.Entity("Models.TaskMaterial", b =>
                {
                    b.HasOne("Models.Inventory", "Material")
                        .WithMany()
            ...
            modelBuilder.Entity("Models.TicketHistory", b =>
                {
                    b.HasOne("Models.ApplicationUser", "Shopper")
                        .WithMany()
            ...
            modelBuilder.Entity("Models.WorkOrder", b =>
                {
                    ...
                    b.HasOne("Models.StreetServiceRequest", "StreetServiceRequest")
                        .WithOne("WorkOrder")
                        .HasForeignKey("Models.WorkOrder", "StreetServiceRequestId");
            ...
            modelBuilder.Entity("Models.TaskType", b =>
                {
                    b.Navigation("TaskEquipment");

                    b.Navigation("TaskLabors");

                    b.Navigation("TaskMaterials");

                    b.Navigation("TaskWorkSteps");
                });
