...
namespace Repositories.Common
{
        ...
        where UpdateViewModel : class, IBaseCrudViewModel, IIdentitifier, new()
    {
        ...
        public override async Task<Expression<Func<AssetIncident, bool>>> SetQueryFilter(IBaseSearchModel filters)
        {
            var searchFilters = filters as AssetIdSearchViewModel;
